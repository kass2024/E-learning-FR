      ...
      <section className="public-page-offset pb-20 px-4 bg-gradient-to-b from-blue-50 via-white to-white border-b border-slate-200">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
            <div>
              <Badge className="mb-4 bg-[#FCC400]/20 text-[#0070D0] border border-[#FCC400]/40">
                About us
              </Badge>
              ...
              <p className="text-lg md:text-xl text-slate-700 mb-6 max-w-xl">
                School of Fluency and Proficiency — quality language education at affordable prices.
              </p>
              <p className="text-sm md:text-base text-slate-700 max-w-xl">
                F&R Rwanda Ltd offers interactive online English, French, and Kinyarwanda courses with experienced instructors,
                flexible schedules, and personalized feedback so you can learn today, master tomorrow, and succeed globally.
              </p>
            </div>

            <div className="relative">
              <div
                className="absolute -inset-6 bg-gradient-to-tr from-[#FCC400]/25 via-sky-400/15 to-blue-400/15 blur-3xl"
                aria-hidden="true"
              />
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="grid gap-8 md:grid-cols-2">
            <Card className="border border-[#1A8AD8]/15 bg-white shadow-sm hover:shadow-lg hover:border-[#FCC400]/60 transition-all rounded-2xl">
              <CardHeader>
